      ...
      <div className="locationDetailExplainCover">
        ...
        <div className="locationDetailExplainTextImgCover">
          ...
          <div className="locationDetailExplainTextCover">
            <h3 className="locationDetailExplainTitle">
              {rankingData?.description?.title?.[lang]}
            </h3>
            <p
              ref={explainRef}
              id={explainId}
            ...
            {isOverflowing && (
              ...
              >
                ...
                <svg
                  ...
                  className="lucide lucide-chevron-down-icon lucide-chevron-down locationDetailExplainMoreIcon"
                >
                  <path d="m6 9 6 6 6-6" />
                </svg>
              </button>
            )}
            <p className="locationDetailExplainLast subFont">
              {rankingData?.description?.last?.[lang]}
            </p>
          </div>
        </div>
      </div>
