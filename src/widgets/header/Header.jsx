...
const Header = () => {
  ...
  const getLogoImage = () => {
    if (isKo) {
      return showDarkHeader
        ? "/images/logo/logoTextSc.png"
        : "/images/logo/logoText.png";
    }
    return showDarkHeader
      ? "/images/logo/logoTextEnSc.png"
      : "/images/logo/logoTextEn.png";
  };
      ...
      <div className="headerCover contentWidthException">
        ...
        <div className="utilityBar">
          {!isFullMobile && (
            <>
              <button
                className={`desktopSearchBtn ${showDarkHeader ? "dark" : ""}`}
                onClick={() => setIsSearchOpen(true)}
                aria-label={isKo ? "여행지 검색" : "Search destinations"}
              >
                <svg
                  ...
                  className="lucide lucide-search-icon lucide-search headerSearch"
                >
              ...
              >
                ...
                {authUser && (
                  <span className="profileStatusDot" aria-hidden="true" />
                )}
              </button>
              <div
                className={`desktopLanguage ${showDarkHeader ? "dark" : ""}`}
                ref={languageMenuRef}
              >
                <button
                  type="button"
                ...
                <div
                  className={`desktopLanguageMenu ${isLanguageOpen ? "open" : ""}`}
                  role="listbox"
                  aria-label={t("header.setLanguage")}
                >
                  <button
                    type="button"
                    role="option"
                    aria-selected={isKo}
                    className={isKo ? "selected" : ""}
            ...
            <div className="mobileUtility">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke={showDarkHeader ? "#1a1a1a" : "#fafaf8"}
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                >
      ...
      <div className={`mobileMenuWrapper ${isMenuOpen ? "open" : ""}`}>
        ...
        <div className="mobileMenuContent">
          ...
          <div className="mobileMenuSearch">
            ...
            >
              ...
              <span>
                {isKo
                  ? "여행지 이름이나 키워드를 검색하세요"
                  : "Search destinations or keywords"}
              </span>
            </button>
          ...
          <div className="mobileMenuCategories">
            <p className="categoryTitle">{t("header.category")}</p>
            <ul>
                ...
                >
                  <div className="menuItemLeft">
                    <div className="menuItemIcon">
                      <img
                        src={`/images/header/icon/${icon}.png`}
                        alt={label}
                      />
                    </div>
                    <span>{label}</span>
